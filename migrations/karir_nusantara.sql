...
(7, 7, 2, 0, '2026-02-09 13:08:28', '2026-02-11 15:34:18');
...
--
-- Dumping data for table `interview_question_options`
--

INSERT INTO `interview_question_options` (`id`, `interview_question_id`, `option_text`, `is_correct`, `order`, `created_at`, `updated_at`) VALUES
(1, 1, 'Netral', 0, 1, '2026-02-19 18:15:20', '2026-02-19 18:15:20'),
...
CREATE TABLE `jobs` (
  ...
  `is_salary_fixed` tinyint(1) NOT NULL DEFAULT 0,
...
INSERT INTO `jobs` (`id`, `company_id`, `title`, `category`, `slug`, `description`, `requirements`, `responsibilities`, `benefits`, `city`, `province`, `is_remote`, `job_type`, `experience_level`, `salary_min`, `salary_max`, `salary_currency`, `is_salary_visible`, `is_salary_fixed`, `application_deadline`, `max_applications`, `status`, `admin_status`, `admin_note`, `flag_reason`, `views_count`, `applications_count`, `shares_count`, `edit_count`, `published_at`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 2, 'Senior Software Engineer', 'Engineering', 'senior-software-engineer', 'Kami mencari Senior Software Engineer untuk bergabung dengan tim development kami. Anda akan bekerja dengan teknologi terkini dan tim yang solid. Minimal pengalaman 3 tahun.', 'Minimal 3 tahun pengalaman. Menguasai Go/Python.', NULL, NULL, 'Jakarta Selatan', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-17 02:49:00', '2026-01-17 02:46:11', '2026-01-17 02:49:00', NULL),
(2, 2, 'Test Status Job', 'Engineering', 'test-status-job', 'Ini adalah deskripsi panjang untuk testing job status management endpoints yang baru ditambahkan.', NULL, NULL, NULL, 'Jakarta', 'DKI Jakarta', 0, 'full_time', 'mid', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'closed', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-17 03:13:52', '2026-01-17 03:13:25', '2026-01-17 03:14:15', NULL),
(3, 4, 'Senior Software Engineer', 'Engineering', 'senior-software-engineer-1768720323', 'We are looking for an experienced software engineer', '5+ years experience with Go or Python', 'Build and maintain backend systems', 'Competitive salary, remote work', 'Jakarta Selatan', 'DKI Jakarta', 1, 'full_time', 'senior', 20000000, 35000000, 'IDR', 1, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-18 07:12:10', '2026-01-18 07:12:03', '2026-01-18 07:12:19', NULL),
(4, 10, 'Senior Backend Engineer', 'Engineering', 'senior-backend-engineer', 'Kami mencari Senior Backend Engineer yang berpengalaman dalam mengembangkan sistem scalable', '- Minimal 5 tahun pengalaman backend development\n- Mahir Go, Python, atau Java\n- Pengalaman dengan microservices\n- Pengalaman dengan database SQL dan NoSQL', '- Merancang dan mengimplementasi API\n- Melakukan code review\n- Mengoptimalkan performance sistem\n- Mentoring junior developers', '- Gaji kompetitif 15-25 juta/bulan\n- Asuransi kesehatan\n- Work from home flexibility\n- Training budget', 'Jakarta Selatan', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-19 07:48:04', '2026-01-19 07:48:03', '2026-01-19 07:48:04', NULL),
(5, 10, 'Full Stack Developer', 'Engineering', 'full-stack-developer', 'Bergabunglah dengan tim kami sebagai Full Stack Developer', '- Minimal 3 tahun pengalaman\n- React atau Vue.js\n- Node.js atau Python', '- Develop frontend dan backend\n- Collaborate dengan tim design', '- Gaji 8-12 juta/bulan\n- Remote friendly', 'Jakarta Pusat', 'DKI Jakarta', 1, 'full_time', 'mid', 8000000, 12000000, 'IDR', 1, 0, NULL, NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-19 07:48:03', '2026-01-19 07:48:03', NULL),
(6, 10, 'UI/UX Designer', 'Engineering', 'uiux-designer', 'Kami mencari UI/UX Designer untuk mengembangkan product kami', '- 2+ tahun pengalaman UI/UX\n- Figma atau Adobe XD', '- Design interface\n- User research', '- Gaji 6-10 juta/bulan', 'Jakarta Selatan', 'DKI Jakarta', 1, 'full_time', 'junior', 6000000, 10000000, 'IDR', 1, 0, NULL, NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-19 07:48:03', '2026-01-19 07:48:03', NULL),
(7, 1, 'Senior Backend Developer', 'Engineering', 'senior-backend-developer', 'We are looking for an experienced backend developer...', 'Node.js, TypeScript, Docker', 'Design and implement APIs', NULL, 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 07:33:46', '2026-01-20 03:43:14', '2026-01-20 07:33:46', NULL),
(8, 1, 'Senior Frontend Developer', 'Engineering', 'senior-frontend-developer', 'Kami mencari Senior Frontend Developer yang berpengalaman dalam React.js dan TypeScript untuk bergabung dengan tim kami. Posisi ini akan bertanggung jawab untuk mengembangkan fitur-fitur baru.', '- Minimal 3 tahun pengalaman dengan React.js\n- Menguasai TypeScript', NULL, NULL, 'Jakarta Selatan', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 05:05:33', '2026-01-20 05:05:33', '2026-01-20 06:11:28', '2026-01-20 06:11:28'),
(9, 1, 'Senior Frontend Developer', 'Engineering', 'senior-frontend-developer-1768885756', 'Kami mencari Senior Frontend Developer yang berpengalaman dalam React.js dan TypeScript untuk bergabung dengan tim kami. Posisi ini akan bertanggung jawab untuk mengembangkan fitur-fitur baru.', '- Minimal 3 tahun pengalaman dengan React.js\n- Menguasai TypeScript', NULL, NULL, 'Jakarta Selatan', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 05:09:16', '2026-01-20 05:09:16', '2026-01-20 06:11:08', '2026-01-20 06:11:08'),
(10, 1, 'Senior Frontend Developer', 'Engineering', 'senior-frontend-developer-1768886367', 'Kami mencari Senior Frontend Developer yang berpengalaman dalam React.js.', 'Minimal 3 tahun pengalaman', NULL, NULL, 'Jakarta Selatan', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, NULL, NULL, 'closed', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 05:19:27', '2026-01-20 05:19:27', '2026-01-20 06:10:33', NULL),
(11, 1, 'Senior Frontend Developer', 'Engineering', 'senior-frontend-developer-1768886376', 'Kami mencari Senior Frontend Developer yang berpengalaman dalam React.js.', 'Minimal 3 tahun pengalaman', NULL, NULL, 'Jakarta Selatan', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 05:19:36', '2026-01-20 05:19:36', '2026-01-20 06:09:48', '2026-01-20 06:09:48'),
(12, 1, 'Mobile Apps Developer', 'Engineering', 'mobile-apps-developer', 'Full job description\nAbout this Role\n\nWe are seeking a highly experienced Flutter Developer to join our mobile development team. In this role, you will take the lead in architecting and building advanced mobile applications, driving technical excellence, and contributing to high-impact projects. You will collaborate with top-tier cross-functional teams to deliver innovative, scalable, and high-performance solutions.\n\nJob Description\n\nAs a Senior Flutter Developer, you will be responsible for designing, developing, and maintaining sophisticated mobile applications in a fast-paced and innovation-driven environment.\n\nWhat It’s Like to Work Here as a Senior Flutter Mobile App DeveloperFull-cycle Technical Ownership\n\nLead the end-to-end development lifecycle of mobile applications using Flutter, from system design and architecture to deployment and maintenance.\nUI/UX Collaboration\n\nTransform complex UI/UX designs into intuitive and polished user experiences, ensuring pixel-perfect implementations and smooth interactions.\nAdvanced Integration Expertise\n\nArchitect and integrate mobile applications with robust backend systems, ensuring high performance, security, and real-time synchronization.\nCode Quality & Engineering Standards\n\nDrive and participate in in-depth code reviews, ensuring clean architecture, maintainability, and adherence to best practices across the team.\nPerformance & Scalability Optimization\n\nIdentify performance bottlenecks, analyze app behavior, and implement advanced optimization techniques across devices and platforms.\nInnovation & Technical Leadership\n\nContribute forward-thinking ideas, mentor junior developers, and help shape technical strategy and direction.\nCross-functional Technical Collaboration\n\nWork closely with product managers, backend developers, and UI/UX teams to deliver seamless, scalable solutions on time.\nContinuous Learning & Research\n\nStay ahead of the latest trends in Flutter, mobile technologies, and tools—recommending and driving adoption of relevant advancements.\nRobust Testing & Quality Assurance\n\nDevelop automated testing, debugging strategies, and quality assurance processes to ensure enterprise-level reliability and security.', 'Requirements\n\nBachelor\'s degree in Computer Science or related field (or equivalent experience).\n5+ years of professional mobile development experience, with 3+ years specifically in Flutter.\nA strong portfolio showcasing complex, high-quality Flutter applications.\nMastery of Flutter, Dart, state management (e.g., Bloc, Riverpod, Provider, GetX), and modular architecture patterns.\nProven experience integrating APIs, working with real-time data, and using third-party libraries efficiently.\nHands-on experience with backend technologies (Node.js, Django, Firebase) is a strong advantage.\nFamiliarity with CI/CD pipelines, automated testing, and modern mobile DevOps practices.\nExperience publishing and maintaining apps on the App Store and Google Play.', NULL, NULL, 'Sidaorjo', 'Jawa Timur', 0, 'full_time', 'junior', 5000000, 5500000, 'IDR', 1, 0, '2026-02-20', NULL, 'closed', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 05:19:42', '2026-01-20 05:19:42', '2026-01-25 03:46:15', NULL),
(13, 1, 'Test Job API Debug', 'Engineering', 'test-job-api-debug', 'Testing job creation for debug purposes and verification of company_id field. This is a longer description to pass validation.', 'Testing requirements that need to be longer for validation.', NULL, NULL, 'Jakarta', 'DKI Jakarta', 0, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 05:30:01', '2026-01-20 05:30:01', '2026-01-20 06:08:42', '2026-01-20 06:08:42'),
(14, 1, 'Mobile Apps Developer', 'Engineering', 'mobile-apps-developer-1768890085', 'About this Role\n\nWe are seeking a highly experienced Flutter Developer to join our mobile development team. In this role, you will take the lead in architecting and building advanced mobile applications, driving technical excellence, and contributing to high-impact projects. You will collaborate with top-tier cross-functional teams to deliver innovative, scalable, and high-performance solutions.\n\nJob Description\n\nAs a Senior Flutter Developer, you will be responsible for designing, developing, and maintaining sophisticated mobile applications in a fast-paced and innovation-driven environment.\n\nWhat It’s Like to Work Here as a Senior Flutter Mobile App DeveloperFull-cycle Technical Ownership\n\nLead the end-to-end development lifecycle of mobile applications using Flutter, from system design and architecture to deployment and maintenance.\nUI/UX Collaboration\n\nTransform complex UI/UX designs into intuitive and polished user experiences, ensuring pixel-perfect implementations and smooth interactions.\nAdvanced Integration Expertise\n\nArchitect and integrate mobile applications with robust backend systems, ensuring high performance, security, and real-time synchronization.\nCode Quality & Engineering Standards\n\nDrive and participate in in-depth code reviews, ensuring clean architecture, maintainability, and adherence to best practices across the team.\nPerformance & Scalability Optimization\n\nIdentify performance bottlenecks, analyze app behavior, and implement advanced optimization techniques across devices and platforms.\nInnovation & Technical Leadership\n\nContribute forward-thinking ideas, mentor junior developers, and help shape technical strategy and direction.\nCross-functional Technical Collaboration\n\nWork closely with product managers, backend developers, and UI/UX teams to deliver seamless, scalable solutions on time.\nContinuous Learning & Research\n\nStay ahead of the latest trends in Flutter, mobile technologies, and tools—recommending and driving adoption of relevant advancements.\nRobust Testing & Quality Assurance\n\nDevelop automated testing, debugging strategies, and quality assurance processes to ensure enterprise-level reliability and security.', 'Requirements\n\nBachelor\'s degree in Computer Science or related field (or equivalent experience).\n5+ years of professional mobile development experience, with 3+ years specifically in Flutter.\nA strong portfolio showcasing complex, high-quality Flutter applications.\nMastery of Flutter, Dart, state management (e.g., Bloc, Riverpod, Provider, GetX), and modular architecture patterns.\nProven experience integrating APIs, working with real-time data, and using third-party libraries efficiently.\nHands-on experience with backend technologies (Node.js, Django, Firebase) is a strong advantage.\nFamiliarity with CI/CD pipelines, automated testing, and modern mobile DevOps practices.\nExperience publishing and maintaining apps on the App Store and Google Play.', NULL, NULL, 'Sidaorjo', 'Jawa Timur', 0, 'full_time', 'junior', 5000000, 5500000, 'IDR', 1, 0, '2026-02-20', NULL, 'closed', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 06:21:25', '2026-01-20 06:21:25', '2026-01-20 07:02:12', '2026-01-20 07:02:12'),
(15, 1, 'QA Engineer', 'Engineering', 'qa-engineer', 'Looking for experienced QA Engineer to join our team. You will be responsible for testing our applications and ensuring quality standards are met. Must have experience with automated testing tools.', '3+ years experience in QA testing', NULL, NULL, 'Jakarta', 'DKI Jakarta', 0, 'full_time', 'mid', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 07:34:26', '2026-01-20 07:34:26', '2026-01-20 07:34:26', NULL),
(16, 1, 'DevOps Engineer', 'Engineering', 'devops-engineer', 'Looking for experienced DevOps Engineer to manage our cloud infrastructure. You will be responsible for CI/CD pipelines and infrastructure automation.', '3+ years experience with AWS, Docker, Kubernetes', NULL, NULL, 'Surabaya', 'Jawa Timur', 1, 'full_time', 'mid', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 07:39:03', '2026-01-20 07:39:03', '2026-01-20 07:39:03', NULL),
(17, 1, 'Senior Developer - Job 1', 'Engineering', 'senior-developer-job-1', 'Kami mencari senior developer yang berpengalaman untuk bergabung dengan tim kami.', 'Pengalaman minimal 5 tahun di bidang development, menguasai TypeScript, React, dan Go', 'Mengembangkan fitur baru, melakukan code review, dan mentoring junior developer', 'Asuransi kesehatan, bonus tahunan, work from home', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, '2026-02-20', NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:36:05', '2026-01-20 09:36:05', NULL),
(18, 1, 'Senior Developer - Job 2', 'Engineering', 'senior-developer-job-2', 'Kami mencari senior developer yang berpengalaman untuk bergabung dengan tim kami.', 'Pengalaman minimal 5 tahun di bidang development, menguasai TypeScript, React, dan Go', 'Mengembangkan fitur baru, melakukan code review, dan mentoring junior developer', 'Asuransi kesehatan, bonus tahunan, work from home', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, '2026-02-20', NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:36:05', '2026-01-20 09:36:05', NULL),
(19, 1, 'Senior Developer - Job 3', 'Engineering', 'senior-developer-job-3', 'Kami mencari senior developer yang berpengalaman untuk bergabung dengan tim kami.', 'Pengalaman minimal 5 tahun di bidang development, menguasai TypeScript, React, dan Go', 'Mengembangkan fitur baru, melakukan code review, dan mentoring junior developer', 'Asuransi kesehatan, bonus tahunan, work from home', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, '2026-02-20', NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:36:06', '2026-01-20 09:36:06', NULL),
(20, 1, 'Senior Developer - Job 4', 'Engineering', 'senior-developer-job-4', 'Kami mencari senior developer yang berpengalaman untuk bergabung dengan tim kami.', 'Pengalaman minimal 5 tahun di bidang development, menguasai TypeScript, React, dan Go', 'Mengembangkan fitur baru, melakukan code review, dan mentoring junior developer', 'Asuransi kesehatan, bonus tahunan, work from home', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, '2026-02-20', NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:36:06', '2026-01-20 09:36:06', NULL),
(21, 1, 'Senior Developer - Job 5', 'Engineering', 'senior-developer-job-5', 'Kami mencari senior developer yang berpengalaman untuk bergabung dengan tim kami.', 'Pengalaman minimal 5 tahun di bidang development, menguasai TypeScript, React, dan Go', 'Mengembangkan fitur baru, melakukan code review, dan mentoring junior developer', 'Asuransi kesehatan, bonus tahunan, work from home', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, '2026-02-20', NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:36:06', '2026-01-20 09:36:06', NULL),
(22, 1, 'Senior Developer - Job 6', 'Engineering', 'senior-developer-job-6', 'Kami mencari senior developer yang berpengalaman untuk bergabung dengan tim kami.', 'Pengalaman minimal 5 tahun di bidang development, menguasai TypeScript, React, dan Go', 'Mengembangkan fitur baru, melakukan code review, dan mentoring junior developer', 'Asuransi kesehatan, bonus tahunan, work from home', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, '2026-02-20', NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:36:06', '2026-01-20 09:36:06', NULL),
(23, 1, 'Senior Developer - Job 7', 'Engineering', 'senior-developer-job-7', 'Kami mencari senior developer yang berpengalaman untuk bergabung dengan tim kami.', 'Pengalaman minimal 5 tahun di bidang development, menguasai TypeScript, React, dan Go', 'Mengembangkan fitur baru, melakukan code review, dan mentoring junior developer', 'Asuransi kesehatan, bonus tahunan, work from home', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, '2026-02-20', NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:36:06', '2026-01-20 09:36:06', NULL),
(24, 1, 'Senior Developer - Job 8', 'Engineering', 'senior-developer-job-8', 'Kami mencari senior developer yang berpengalaman untuk bergabung dengan tim kami.', 'Pengalaman minimal 5 tahun di bidang development, menguasai TypeScript, React, dan Go', 'Mengembangkan fitur baru, melakukan code review, dan mentoring junior developer', 'Asuransi kesehatan, bonus tahunan, work from home', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, '2026-02-20', NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:36:06', '2026-01-20 09:36:06', NULL),
(25, 1, 'Senior Developer - Job 9', 'Engineering', 'senior-developer-job-9', 'Kami mencari senior developer yang berpengalaman untuk bergabung dengan tim kami.', 'Pengalaman minimal 5 tahun di bidang development, menguasai TypeScript, React, dan Go', 'Mengembangkan fitur baru, melakukan code review, dan mentoring junior developer', 'Asuransi kesehatan, bonus tahunan, work from home', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, '2026-02-20', NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:36:06', '2026-01-20 09:36:06', NULL),
(26, 1, 'Senior Developer - Job 10', 'Engineering', 'senior-developer-job-10', 'Kami mencari senior developer yang berpengalaman untuk bergabung dengan tim kami.', 'Pengalaman minimal 5 tahun di bidang development, menguasai TypeScript, React, dan Go', 'Mengembangkan fitur baru, melakukan code review, dan mentoring junior developer', 'Asuransi kesehatan, bonus tahunan, work from home', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 1, 0, '2026-02-20', NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:36:06', '2026-01-20 09:36:06', NULL),
(27, 1, 'Senior Developer - Job 11 (Should Fail)', 'Engineering', 'senior-developer-job-11-should-fail', 'Ini adalah job ke-11 yang seharusnya gagal karena kuota gratis sudah habis', 'Pengalaman minimal 5 tahun', NULL, NULL, 'Jakarta', 'DKI Jakarta', 0, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:36:06', '2026-01-20 09:36:06', NULL),
(28, 1, 'Senior Dev Job 1', 'Engineering', 'senior-dev-job-1', 'We are hiring a senior developer with 5+ years experience', '5+ years experience, TypeScript, React, Go', NULL, NULL, 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:37:13', '2026-01-20 09:37:13', '2026-01-20 09:37:13', NULL),
(29, 1, 'Senior Dev Job 2', 'Engineering', 'senior-dev-job-2', 'We are hiring a senior developer with 5+ years experience', '5+ years experience, TypeScript, React, Go', NULL, NULL, 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:37:13', '2026-01-20 09:37:13', '2026-01-20 09:37:13', NULL),
(30, 1, 'Senior Dev Job 3', 'Engineering', 'senior-dev-job-3', 'We are hiring a senior developer with 5+ years experience', '5+ years experience, TypeScript, React, Go', NULL, NULL, 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:37:13', '2026-01-20 09:37:13', '2026-01-20 09:37:13', NULL),
(31, 1, 'Senior Dev Job 4', 'Engineering', 'senior-dev-job-4', 'We are hiring a senior developer with 5+ years experience', '5+ years experience, TypeScript, React, Go', NULL, NULL, 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:37:13', '2026-01-20 09:37:13', '2026-01-20 09:37:13', NULL),
(32, 1, 'Senior Dev Job 5', 'Engineering', 'senior-dev-job-5', 'We are hiring a senior developer with 5+ years experience', '5+ years experience, TypeScript, React, Go', NULL, NULL, 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:37:13', '2026-01-20 09:37:13', '2026-01-20 09:37:13', NULL),
(33, 1, 'Senior Dev Job 6', 'Engineering', 'senior-dev-job-6', 'We are hiring a senior developer with 5+ years experience', '5+ years experience, TypeScript, React, Go', NULL, NULL, 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:37:13', '2026-01-20 09:37:13', '2026-01-20 09:37:13', NULL),
(34, 1, 'Senior Dev Job 7', 'Engineering', 'senior-dev-job-7', 'We are hiring a senior developer with 5+ years experience', '5+ years experience, TypeScript, React, Go', NULL, NULL, 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:37:13', '2026-01-20 09:37:13', '2026-01-20 09:37:13', NULL),
(35, 1, 'Senior Dev Job 8', 'Engineering', 'senior-dev-job-8', 'We are hiring a senior developer with 5+ years experience', '5+ years experience, TypeScript, React, Go', NULL, NULL, 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:37:13', '2026-01-20 09:37:13', '2026-01-20 09:37:13', NULL),
(36, 1, 'Senior Dev Job 9', 'Engineering', 'senior-dev-job-9', 'We are hiring a senior developer with 5+ years experience', '5+ years experience, TypeScript, React, Go', NULL, NULL, 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:37:13', '2026-01-20 09:37:13', '2026-01-20 09:37:13', NULL),
(37, 1, 'Senior Developer Position 1', 'Engineering', 'senior-developer-position-1', 'We are looking for an experienced senior developer with at least 5 years of experience in modern web technologies including TypeScript, React, and backend frameworks.', 'Minimum 5 years of experience with TypeScript, React, Go, and PostgreSQL. Strong problem-solving skills required.', 'Develop and maintain web applications, conduct code reviews, mentor junior developers, and participate in architectural decisions.', 'Competitive salary, health insurance, performance bonus, work from home flexibility, professional development opportunities.', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:38:16', '2026-01-20 09:38:16', '2026-01-20 09:38:16', NULL),
(38, 1, 'Senior Developer Position 2', 'Engineering', 'senior-developer-position-2', 'We are looking for an experienced senior developer with at least 5 years of experience in modern web technologies including TypeScript, React, and backend frameworks.', 'Minimum 5 years of experience with TypeScript, React, Go, and PostgreSQL. Strong problem-solving skills required.', 'Develop and maintain web applications, conduct code reviews, mentor junior developers, and participate in architectural decisions.', 'Competitive salary, health insurance, performance bonus, work from home flexibility, professional development opportunities.', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:38:16', '2026-01-20 09:38:16', '2026-01-20 09:38:16', NULL),
(39, 1, 'Senior Developer Position 3', 'Engineering', 'senior-developer-position-3', 'We are looking for an experienced senior developer with at least 5 years of experience in modern web technologies including TypeScript, React, and backend frameworks.', 'Minimum 5 years of experience with TypeScript, React, Go, and PostgreSQL. Strong problem-solving skills required.', 'Develop and maintain web applications, conduct code reviews, mentor junior developers, and participate in architectural decisions.', 'Competitive salary, health insurance, performance bonus, work from home flexibility, professional development opportunities.', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:38:16', '2026-01-20 09:38:16', '2026-01-20 09:38:16', NULL),
(40, 1, 'Senior Developer Position 4', 'Engineering', 'senior-developer-position-4', 'We are looking for an experienced senior developer with at least 5 years of experience in modern web technologies including TypeScript, React, and backend frameworks.', 'Minimum 5 years of experience with TypeScript, React, Go, and PostgreSQL. Strong problem-solving skills required.', 'Develop and maintain web applications, conduct code reviews, mentor junior developers, and participate in architectural decisions.', 'Competitive salary, health insurance, performance bonus, work from home flexibility, professional development opportunities.', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:38:16', '2026-01-20 09:38:16', '2026-01-20 09:38:16', NULL),
(41, 1, 'Senior Developer Position 5', 'Engineering', 'senior-developer-position-5', 'We are looking for an experienced senior developer with at least 5 years of experience in modern web technologies including TypeScript, React, and backend frameworks.', 'Minimum 5 years of experience with TypeScript, React, Go, and PostgreSQL. Strong problem-solving skills required.', 'Develop and maintain web applications, conduct code reviews, mentor junior developers, and participate in architectural decisions.', 'Competitive salary, health insurance, performance bonus, work from home flexibility, professional development opportunities.', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:38:16', '2026-01-20 09:38:16', '2026-01-20 09:38:16', NULL),
(42, 1, 'Senior Developer Position 6', 'Engineering', 'senior-developer-position-6', 'We are looking for an experienced senior developer with at least 5 years of experience in modern web technologies including TypeScript, React, and backend frameworks.', 'Minimum 5 years of experience with TypeScript, React, Go, and PostgreSQL. Strong problem-solving skills required.', 'Develop and maintain web applications, conduct code reviews, mentor junior developers, and participate in architectural decisions.', 'Competitive salary, health insurance, performance bonus, work from home flexibility, professional development opportunities.', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:38:16', '2026-01-20 09:38:16', '2026-01-20 09:38:16', NULL),
(43, 1, 'Senior Developer Position 7', 'Engineering', 'senior-developer-position-7', 'We are looking for an experienced senior developer with at least 5 years of experience in modern web technologies including TypeScript, React, and backend frameworks.', 'Minimum 5 years of experience with TypeScript, React, Go, and PostgreSQL. Strong problem-solving skills required.', 'Develop and maintain web applications, conduct code reviews, mentor junior developers, and participate in architectural decisions.', 'Competitive salary, health insurance, performance bonus, work from home flexibility, professional development opportunities.', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 1, 1, 1, 0, '2026-01-20 09:38:16', '2026-01-20 09:38:16', '2026-01-23 15:07:00', NULL),
(44, 1, 'Senior Developer Position 8', 'Engineering', 'senior-developer-position-8', 'We are looking for an experienced senior developer with at least 5 years of experience in modern web technologies including TypeScript, React, and backend frameworks.', 'Minimum 5 years of experience with TypeScript, React, Go, and PostgreSQL. Strong problem-solving skills required.', 'Develop and maintain web applications, conduct code reviews, mentor junior developers, and participate in architectural decisions.', 'Competitive salary, health insurance, performance bonus, work from home flexibility, professional development opportunities.', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:38:16', '2026-01-20 09:38:16', '2026-01-20 09:38:16', NULL),
(45, 1, 'Senior Developer Position 9', 'Engineering', 'senior-developer-position-9', 'We are looking for an experienced senior developer with at least 5 years of experience in modern web technologies including TypeScript, React, and backend frameworks.', 'Minimum 5 years of experience with TypeScript, React, Go, and PostgreSQL. Strong problem-solving skills required.', 'Develop and maintain web applications, conduct code reviews, mentor junior developers, and participate in architectural decisions.', 'Competitive salary, health insurance, performance bonus, work from home flexibility, professional development opportunities.', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'senior', 15000000, 25000000, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:38:16', '2026-01-20 09:38:16', '2026-01-20 09:38:16', NULL),
(46, 1, 'Extra Job Beyond Quota', 'Engineering', 'extra-job-beyond-quota', 'This job should fail because we have exhausted all free quota and have not paid for additional quota.', 'Experience required', 'Development work', 'Benefits provided', 'Jakarta', 'DKI Jakarta', 0, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-20 09:38:16', '2026-01-20 09:38:16', '2026-01-20 09:38:16', NULL),
(47, 1, 'Frontend Developer - Draft Test', 'Engineering', 'frontend-developer-draft-test', 'Ini adalah lowongan test yang disimpan sebagai draft. Deskripsi minimal 50 karakter untuk validasi.', 'Persyaratan test minimal 30 karakter untuk validasi.', NULL, NULL, 'Jakarta', 'DKI Jakarta', 0, 'full_time', 'junior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 09:55:43', '2026-01-20 09:55:43', NULL),
(48, 1, 'Sales Marketing', 'Engineering', 'sales-marketing', 'Tanggung Jawab Pekerjaan\n\nMencapai target\nMenjaga hubungan dengan pelanggan\nRiset pemasaran\nMenjalankan promosi perusahaan\nSyarat & Keahlian\n\nMin lulusan SMA\nUsia 20 - 45 tahun\nPengalaman tidak diutamakan\nPria/Wanita\nRajin dan bertanggung jawab\n\nPengalaman\n\nTidak diutamakan\nBenefit\n\nKomisi, Piknik', 'Max age 28\nMinimum Bachelor Degree in any major\nMin GPA 3.00\nFresh graduates are welcome to apply\nInterest to work in broadcasting industry\nHave a good looking\nHave a good communication & presentation skill\nHave a good networking skill', NULL, NULL, 'Sidaorjo', 'Jawa Timur', 0, 'contract', 'junior', 4000000, 4000000, 'IDR', 1, 0, '2026-02-12', NULL, 'draft', NULL, NULL, NULL, 0, 0, 0, 0, NULL, '2026-01-20 10:00:06', '2026-01-20 10:00:06', NULL),
(49, 1, 'Graphic Designer', 'Engineering', 'graphic-designer', 'This is a full-time remote Senior Graphic Designer role starting in March. You will create polished, globally appealing designs for social media, e-commerce, and marketing campaigns, working closely with an international team. Intermediate English communication is required.\nWork Type: Remote\nEmployment: Full-time\nLevel: Senior\nEnglish: Intermediate (daily team communication)\nSalary: HKD 5,000 / month\n≈ IDR 10,800,000 / month\n\nKey Responsibilities\nCreate high-quality visual designs for social media, ads, campaigns, and e-commerce\nDesign using Canva as the main tool for all primary visuals\nEnsure designs meet international beauty brand standards\nMaintain brand consistency across all platforms\nCollaborate with cross-border teams and respond to feedback\nPrepare final assets for digital publishing', 'Senior-level experience (3+ years) as a Graphic Designer\nExcellent Canva skills (primary tool for all main designs)\nStrong understanding of global / international design aesthetics\nAbility to design for international audiences, not local-only styles\nStrong sense of typography, layout, spacing, and color\nIntermediate English (spoken & written) for team communication\nAble to work independently and meet deadlines\nPortfolio showing modern, clean, internationally relevant designs', NULL, NULL, 'Jakarta', 'DKI Jakarta', 0, 'contract', 'junior', 2400000, 3000000, 'IDR', 1, 0, '2026-02-21', NULL, 'active', NULL, NULL, NULL, 1, 0, 2, 0, '2026-01-21 13:52:32', '2026-01-21 13:52:32', '2026-01-23 14:32:51', NULL),
(50, 1, 'Backend Developer - Email Notification Test', 'Engineering', 'backend-developer-email-notification-test', 'Testing email notification feature untuk job posting', 'Menguasai Go, MySQL, dan email integration', NULL, NULL, 'Jakarta', 'DKI Jakarta', 0, 'full_time', 'mid', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-22 03:58:55', '2026-01-22 03:58:55', '2026-01-22 03:58:55', NULL),
(51, 1, 'Frontend Developer - Test Email v2', 'Engineering', 'frontend-developer-test-email-v2', 'Testing email notification feature dengan debug logs untuk memastikan email terkirim dengan benar ke alamat company yang terdaftar', NULL, NULL, NULL, 'Bandung', 'Jawa Barat', 0, 'full_time', 'junior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-22 04:00:54', '2026-01-22 04:00:54', '2026-01-22 04:00:54', NULL),
(52, 1, 'QA Engineer - Email Test With Correct Binary', 'Engineering', 'qa-engineer-email-test-with-correct-binary', 'Testing email notification feature dengan binary yang sudah terupdate untuk memastikan email terkirim dengan sempurna', NULL, NULL, NULL, 'Surabaya', 'Jawa Timur', 0, 'full_time', 'mid', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-22 04:02:07', '2026-01-22 04:02:07', '2026-01-22 04:02:07', NULL),
(53, 1, 'DevOps Engineer - Final Email Notification Test', 'Engineering', 'devops-engineer-final-email-notification-test', 'Testing email notification dengan background context agar tidak ter-cancel saat request selesai dan email dapat terkirim dengan sempurna', NULL, NULL, NULL, 'Yogyakarta', 'DI Yogyakarta', 0, 'full_time', 'senior', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 1, 0, 0, 0, '2026-01-22 04:08:45', '2026-01-22 04:08:45', '2026-01-25 10:25:44', NULL),
(54, 1, 'Accounting', 'Engineering', 'accounting', 'Tentang Kami Twister Communications adalah creative agency yang fokus pada brand activation, event management, dan design services untuk brand multinasional dan lokal di Indonesia.\n\nDeskripsi Pekerjaan Kami mencari Accounting Staff yang teliti untuk mendukung Divisi Finance, Accounting and Tax dalam mengelola tugas Accounting secara keseluruhan sesuai dengan standar operasional Perusahaan.\n\nTugas & Tanggungjawab\n\nMelakukan pencatatan transaksi keuangan harian secara akurat dan tepat waktu\n\nMenyusun dan menginput jurnal akuntansi ke dalam sistem\n\nMelakukan rekonsiliasi bank serta memastikan kesesuaian saldo kas dan bank\n\nMembantu proses closing laporan keuangan bulanan dan tahunan\n\nMenyusun dan memeriksa laporan keuangan (Laba Rugi, Neraca, Arus Kas)\n\nMenyiapkan data pendukung untuk kebutuhan audit internal maupun eksternal\n\nMembantu pengelolaan dan pelaporan perpajakan (PPN, PPh 21, PPh 23, dll)\n\nMengarsipkan dokumen keuangan dan perpajakan secara rapi dan sistematis\n\nMengoperasikan dan memastikan data pada software akuntansi selalu update\n\nMemastikan seluruh proses akuntansi berjalan sesuai SOP dan kebijakan perusahaan\n\nTugas terkait lainnya sesuai yang diberikan', 'Pendidikan minimal S1 Akuntansi\n\nMempunyai pengalaman 1 tahun sebagai Accounting Staff lebih diutamakan\n\nMengetahui program Accounting (contoh: Accurate, ERP)\n\nMahir rumus excel seperti vlookup & pivot\n\nMenguasai Ms Office\n\nTeliti, Jujur, Cekatan dan bertanggung jawab\n\nMampu bekerja dalam lingkungan yang dinamis\n\nMampu bekerja dalam team\n\nDiutamakan berpengalaman pada bidang Jasa\n\nFresh Graduate are Welcome', NULL, NULL, 'Sidaorjo', 'Jawa Timur', 0, 'full_time', 'junior', NULL, NULL, 'IDR', 1, 0, '2026-02-22', NULL, 'active', NULL, NULL, NULL, 1, 0, 0, 0, '2026-01-22 05:52:04', '2026-01-22 05:52:04', '2026-01-25 12:11:37', NULL),
(55, 1, 'Full Stack Developer - Email Test dengan Logging Detail', 'Engineering', 'full-stack-developer-email-test-dengan-logging-detail', 'Kami mencari Full Stack Developer yang berpengalaman untuk bergabung dengan tim kami. Posisi ini akan fokus pada pengembangan aplikasi web modern menggunakan teknologi terkini.', 'Minimal 2 tahun pengalaman, menguasai React, Node.js, dan database', NULL, NULL, 'Jakarta', 'DKI Jakarta', 0, 'full_time', 'mid', NULL, NULL, 'IDR', 0, 0, NULL, NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-01-22 06:17:52', '2026-01-22 06:17:52', '2026-01-22 06:17:52', NULL),
(56, 1, 'Software Engineer SALARY TEST', 'Engineering', 'software-engineer-salary-test', 'This is a test job to verify salary display works correctly on the frontend. We are looking for a talented software engineer.', '3 years experience with Go or TypeScript', 'Develop and maintain backend services', 'Health insurance, remote work', 'Jakarta', 'DKI Jakarta', 1, 'full_time', 'mid', 15000000, 25000000, 'IDR', 1, 0, NULL, NULL, 'active', NULL, NULL, NULL, 2, 1, 1, 0, '2026-01-22 06:45:16', '2026-01-22 06:45:16', '2026-01-25 12:11:26', NULL),
(57, 7, 'Senior Flutter Developer', 'Engineering', 'senior-flutter-developer', 'Kami mencari Senior Mobile Apps Developer berpengalaman yang memiliki keahlian kuat dalam pengembangan aplikasi mobile menggunakan framework Flutter. Kandidat akan bertanggung jawab dalam merancang, mengembangkan, mengoptimalkan, dan memelihara aplikasi mobile berkualitas tinggi untuk platform Android dan iOS, serta berkolaborasi dengan tim backend, UI/UX, dan product team untuk menghasilkan solusi digital yang scalable dan efisien.\n\nTanggung Jawab:\n\nMengembangkan aplikasi mobile menggunakan Flutter dengan performa tinggi dan UI/UX yang optimal\n\nMendesain arsitektur aplikasi yang scalable, maintainable, dan clean code\n\nMengintegrasikan aplikasi dengan REST API / Web Service\n\nMelakukan debugging, testing, dan optimasi performa aplikasi\n\nMembimbing developer junior dan melakukan code review\n\nBerkolaborasi dengan tim lintas divisi dalam proses pengembangan produk\n\nMengikuti perkembangan teknologi mobile dan best practice industri\n\nKualifikasi:\n\nPengalaman minimal 3–5 tahun dalam pengembangan aplikasi mobile\n\nPengalaman kuat menggunakan Flutter dan Dart\n\nMemahami state management (Bloc, Provider, Riverpod, atau sejenisnya)\n\nBerpengalaman integrasi API, JSON parsing, dan authentication\n\nMemahami prinsip Clean Architecture / MVC / MVVM\n\nTerbiasa menggunakan Git version control\n\nMemiliki kemampuan problem solving dan komunikasi yang baik\n\nNilai tambah jika memiliki pengalaman publikasi aplikasi di Play Store / App Store\n\nNilai Tambah (Optional):\n\nPengalaman dengan Firebase (Auth, Firestore, FCM, Analytics)\n\nPengalaman CI/CD mobile apps\n\nPengalaman native Android (Kotlin/Java) atau iOS (Swift)\n\nPengalaman pengembangan real-time apps (WebSocket / MQTT)', 'Persyaratan:\n\nPendidikan minimal S1 Teknik Informatika, Sistem Informasi, atau bidang terkait (atau pengalaman kerja setara)\n\nPengalaman minimal 3–5 tahun dalam pengembangan aplikasi mobile\n\nPengalaman profesional menggunakan Flutter (Dart) dalam pengembangan production app\n\nMemahami konsep State Management (Bloc, Provider, Riverpod, GetX, atau sejenisnya)\n\nBerpengalaman dalam integrasi REST API / Web Service\n\nMemahami konsep Clean Architecture, SOLID Principle, dan Design Pattern\n\nTerbiasa menggunakan Git Version Control (GitHub / GitLab / Bitbucket)\n\nMemahami proses deployment aplikasi ke Google Play Store dan Apple App Store\n\nMampu melakukan debugging, profiling, dan optimasi performa aplikasi\n\nMemiliki kemampuan analisa dan problem solving yang kuat\n\nMampu bekerja secara tim maupun individu\n\nMemiliki komunikasi yang baik dan mampu bekerja dalam lingkungan agile', NULL, NULL, 'Ngagel', 'Surabaya', 0, 'full_time', 'mid', 4000000, NULL, 'IDR', 1, 0, '2026-03-11', NULL, 'active', NULL, NULL, NULL, 1, 1, 0, 0, '2026-02-11 14:54:30', '2026-02-11 14:54:30', '2026-02-11 14:56:30', NULL),
(58, 7, 'Senior Backend Developer', 'Engineering', 'senior-backend-developer-1770824058', 'Berikut deskripsi yang bisa kamu gunakan untuk job posting Senior Backend Developer (Laravel):\n\nSenior Backend Developer (Laravel)\n\nKami mencari Senior Backend Developer yang berpengalaman dalam pengembangan sistem backend menggunakan framework Laravel. Kandidat akan bertanggung jawab dalam merancang arsitektur sistem, mengembangkan API yang scalable, menjaga keamanan sistem, serta memastikan performa aplikasi berjalan optimal. Posisi ini juga berperan dalam memberikan arahan teknis kepada tim developer dan memastikan implementasi best practice dalam pengembangan software.\n\nDeskripsi Pekerjaan:\n\nMerancang, mengembangkan, dan memelihara backend system menggunakan Laravel\n\nMendesain dan mengembangkan RESTful API yang scalable dan secure\n\nMengelola dan mengoptimalkan database (MySQL / PostgreSQL / sejenisnya)\n\nMengimplementasikan autentikasi, otorisasi, dan keamanan sistem\n\nMelakukan code review serta memastikan standar clean code diterapkan dalam tim\n\nBerkolaborasi dengan tim Frontend, Mobile Developer, dan DevOps\n\nMelakukan troubleshooting, debugging, dan optimasi performa server\n\nMembuat dokumentasi teknis sistem dan API\n\nMengikuti perkembangan teknologi backend dan best practice industri\n\nMembantu mentoring backend developer junior atau middle level', 'Pendidikan minimal S1 Teknik Informatika, Sistem Informasi, atau bidang terkait (atau pengalaman kerja setara)\n\nPengalaman minimal 4–6 tahun dalam pengembangan backend system\n\nPengalaman minimal 3 tahun menggunakan Laravel Framework dalam production environment\n\nMenguasai PHP (OOP, Design Pattern, SOLID Principle)\n\nBerpengalaman membuat dan mengelola RESTful API\n\nMemahami arsitektur backend modern (Monolith, Microservices, atau Modular Architecture)\n\nMenguasai database relasional (MySQL / PostgreSQL) termasuk query optimization\n\nMemahami penggunaan ORM (Eloquent) dan query builder Laravel\n\nBerpengalaman menggunakan Git Version Control\n\nMemahami konsep authentication & authorization (JWT, OAuth, Laravel Sanctum / Passport)\n\nTerbiasa bekerja dengan queue system (Redis, RabbitMQ, atau sejenisnya)\n\nMemahami caching mechanism (Redis / Memcached)\n\nMemiliki pengalaman deployment dan environment management (Linux Server, Nginx / Apache)\n\nMampu melakukan debugging, logging, dan performance tuning backend system\n\nMemiliki kemampuan analisa sistem dan problem solving yang kuat\n\nMampu bekerja dalam tim dengan metodologi Agile / Scrum', NULL, NULL, 'Ngagel', 'Surabaya', 0, 'full_time', 'mid', NULL, NULL, 'IDR', 1, 0, '2026-03-11', NULL, 'active', NULL, NULL, NULL, 0, 0, 0, 0, '2026-02-11 15:34:18', '2026-02-11 15:34:18', '2026-02-11 15:34:18', NULL);
...
(408, 26, 'b04fceb6248291f4a827642f2ff9e88e369c0c7250ec097e64af319b8ce3fdc6', '2026-02-18 15:20:46', NULL, '', '', '2026-02-11 15:20:46'),
(409, 26, '106f582a9269952a45301d2c84a1b00a6573629f35886428f5ec72805d991f51', '2026-02-18 15:31:35', NULL, '', '', '2026-02-11 15:31:35'),
(410, 26, '273a511f8c607de8a81e8c85859e7aa1c8d9ce5f302b28243679f4407a3b3be8', '2026-02-18 16:08:45', NULL, '', '', '2026-02-11 16:08:45'),
(411, 26, '6a997e057dfa846c64dd8978b21adedcb931bb19e1dd9a8fc95b857f379b8024', '2026-02-19 11:41:49', NULL, '', '', '2026-02-12 11:41:49'),
(412, 26, '36c787e077b172e1e3ee9c3b0891cf82336c9d2632574828219ca45747aaa4d3', '2026-02-19 11:59:51', NULL, '', '', '2026-02-12 11:59:51'),
(413, 26, '6651660455bb885c3201bc1f956a1a43af1e007e2dda8ae61dfea826e87cfaab', '2026-02-19 13:15:32', NULL, '', '', '2026-02-12 13:15:32'),
(414, 26, '74cd46879881cd2452853a53e92550074b329f6b104248207ffc6b4b9bb68a63', '2026-02-19 14:13:09', NULL, '', '', '2026-02-12 14:13:09'),
...
ALTER TABLE `interview_questions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_test_id` (`interview_test_id`),
  ADD KEY `idx_difficulty` (`difficulty`),
  ADD KEY `idx_order` (`interview_test_id`,`order`);

--
-- Indexes for table `interview_question_options`
--
ALTER TABLE `interview_question_options`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_question_id` (`interview_question_id`),
  ADD KEY `idx_correct` (`is_correct`),
  ADD KEY `idx_order` (`interview_question_id`,`order`);

--
-- Indexes for table `interview_tests`
--
...
--
ALTER TABLE `interview_test_answers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_submission_id` (`submission_id`),
  ADD KEY `idx_question_id` (`interview_question_id`),
  ADD KEY `idx_option_id` (`selected_option_id`);

--
-- Indexes for table `interview_test_submissions`
--
ALTER TABLE `interview_test_submissions`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `jobs`
  ...
  ADD KEY `idx_jobs_status_created_at` (`status`,`created_at`),
  ADD KEY `idx_jobs_company_status` (`company_id`,`status`),
  ADD KEY `idx_jobs_title_status` (`title`,`status`),
  ADD KEY `idx_jobs_views_count` (`views_count`),
  ADD KEY `idx_jobs_applications_count` (`applications_count`),
  ADD KEY `idx_category` (`category`);
...
--
-- AUTO_INCREMENT for table `interview_test_submissions`
--
ALTER TABLE `interview_test_submissions`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `interview_questions`
  ADD CONSTRAINT `interview_questions_ibfk_1` FOREIGN KEY (`interview_test_id`) REFERENCES `interview_tests` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `interview_question_options`
--
ALTER TABLE `interview_question_options`
  ADD CONSTRAINT `interview_question_options_ibfk_1` FOREIGN KEY (`interview_question_id`) REFERENCES `interview_questions` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `interview_tests`
--
ALTER TABLE `interview_tests`
  ADD CONSTRAINT `interview_tests_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `interview_tests_ibfk_2` FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `interview_test_answers`
--
ALTER TABLE `interview_test_answers`
  ADD CONSTRAINT `interview_test_answers_ibfk_1` FOREIGN KEY (`submission_id`) REFERENCES `interview_test_submissions` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `interview_test_answers_ibfk_2` FOREIGN KEY (`interview_question_id`) REFERENCES `interview_questions` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `interview_test_answers_ibfk_3` FOREIGN KEY (`selected_option_id`) REFERENCES `interview_question_options` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `interview_test_submissions`
--
ALTER TABLE `interview_test_submissions`
  ADD CONSTRAINT `interview_test_submissions_ibfk_1` FOREIGN KEY (`interview_test_id`) REFERENCES `interview_tests` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `interview_test_submissions_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `interview_test_submissions_ibfk_3` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `interview_test_submissions_ibfk_4` FOREIGN KEY (`graded_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
